...
import { Plus, Trash2, Save, ArrowLeft, ArrowRight, Upload, Wand2, Edit, ChevronDown, ChevronRight, AlertCircle, CheckCircle, Info, Users, Calendar, DollarSign } from 'lucide-react';
