          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <div className="space-y-1">
                  <label htmlFor="dept-color" className="block text-xs font-medium text-gray-700">
                    Color
                  </label>
                  <input
                    id="dept-color"
                    ...
                    className="w-full h-8 border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="flex items-end">
                  <button
                    ...
                    aria-describedby="add-dept-help"
                    className="w-full bg-blue-600 text-white px-3 py-2 text-sm rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    Add Department
                  </button>
                  <div id="add-dept-help" className="sr-only">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-5 gap-3">
                  ...
                  <AccessibleSelect
                    ...
                    onChange={(value) => setNewPerson({...newPerson, departmentId: value})}
                    options={[
                  ...
                  <div className="flex items-end">
                    <button
                      ...
                      className="w-full bg-green-600 text-white px-3 py-2 text-sm rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                    >
                      Add Person
                    </button>
            ...
            {showPersonnel && deptPersonnel.length > 0 && (
              <div className="mt-3 pt-3 border-t border-gray-200" role="list" aria-label={`Personnel in ${department.name}`}>
                {deptPersonnel.map((person) => (
                  <div key={person.id} className="text-sm text-center mb-1" role="listitem">
